...
function setMaintenanceMode($status)
{
    ...
    file_put_contents('secure_admin/maintenance.txt', ($status ? 'true' : 'false'));
}
...
function isMaintenanceMode()
{
    ...
    $status = file_get_contents('secure_admin/maintenance.txt');
...
// Periksa apakah status maintenance aktif
if (isMaintenanceMode()) {
    // Redirect ke halaman maintenance
    echo '<script>alert("Website under maintenance");</script>';
...
$todayFormatted = $todayDateTime->format('d-m-Y');

$interval = new DateInterval('P1D'); // P1D = periode 1 hari (HARI -1)

$minnolDateTime = clone $todayDateTime;

$minnolFormatted = $minnolDateTime->format('d-m-Y');

$minsatuDateTime = clone $todayDateTime;
$minsatuDateTime->modify('-1 day');
$minsatuFormatted = $minsatuDateTime->format('d-m-Y');

$minduaDateTime = clone $todayDateTime;
$minduaDateTime->modify('-2 days');
$minduaFormatted = $minduaDateTime->format('d-m-Y');

$mintigaDateTime = clone $todayDateTime;
$mintigaDateTime->modify('-3 days');
$mintigaFormatted = $mintigaDateTime->format('d-m-Y');

$minempatDateTime = clone $todayDateTime;
$minempatDateTime->modify('-4 days');
$minempatFormatted = $minempatDateTime->format('d-m-Y');

$minlimaDateTime = clone $todayDateTime;
$minlimaDateTime->modify('-5 days');
$minlimaFormatted = $minlimaDateTime->format('d-m-Y');

$minenamDateTime = clone $todayDateTime;
$minenamDateTime->modify('-6 days');
$minenamFormatted = $minenamDateTime->format('d-m-Y');

$mintujuhDateTime = clone $todayDateTime;
$mintujuhDateTime->modify('-7 days');
$mintujuhFormatted = $mintujuhDateTime->format('d-m-Y');

$mindelapanDateTime = clone $todayDateTime;
$mindelapanDateTime->modify('-8 days');
$mindelapanFormatted = $mindelapanDateTime->format('d-m-Y');

$minsembilanDateTime = clone $todayDateTime;
$minsembilanDateTime->modify('-9 days');
$minsembilanFormatted = $minsembilanDateTime->format('d-m-Y');

$minsepuluhDateTime = clone $todayDateTime;
$minsepuluhDateTime->modify('-10 days');
$minsepuluhFormatted = $minsepuluhDateTime->format('d-m-Y');
...
if (isset($_POST['login'])) {
    ...
    if ($user && password_verify($password, $user['password'])) {
        ...
        echo $errorMessage; // Mengirim pesan error ke AJAX
        exit;
    }
}
...
<body id="desktop">
    ...
    <div id="top" class="wrapper">
            ...
            <div class="offcanvas-body p-0">
                <div class="d-flex flex-column w-100 gap-1">
                    ...
                    <div class="d-flex p-3 w-100 gap-3" style="background: linear-gradient(0deg, rgba(255,255,255,0.05) 0%, rgba(255,255,255,0.05) 100%), var(--secondary-background)">
                        ...
                        <div style="color: var(--text-color); font-size: 1.1rem"><?php echo WA_ADMIN ?></div>
                    </div>
                    <div class="d-flex p-3 w-100 gap-3" style="background: linear-gradient(0deg, rgba(255,255,255,0.05) 0%, rgba(255,255,255,0.05) 100%), var(--secondary-background)">
                        <div class="fw-bold"><img src="https://img.pay4d.info/kontak/line.png" width='20px'></div>
                        <div style="color: var(--text-color); font-size: 1.1rem"><?php echo LINE_ADMIN; ?></div>
                    </div>
                    <div class="d-flex p-3 w-100 gap-3" style="background: linear-gradient(0deg, rgba(255,255,255,0.05) 0%, rgba(255,255,255,0.05) 100%), var(--secondary-background)">
                        <div class="fw-bold"><img src="https://img.pay4d.info/kontak/wechat.png" width='20px'></div>
                        <div style="color: var(--text-color); font-size: 1.1rem"><?php echo WECHAT_ADMIN; ?></div>
                    </div>
                    <div class="d-flex p-3 w-100 gap-3" style="background: linear-gradient(0deg, rgba(255,255,255,0.05) 0%, rgba(255,255,255,0.05) 100%), var(--secondary-background)">
                        <div class="fw-bold"><img src="https://img.pay4d.info/kontak/telegram.png" width='20px'></div>
                        <div style="color: var(--text-color); font-size: 1.1rem"><?php echo TELEGRAM_ADMIN; ?></div>
                    </div>
                    <div class="d-flex p-3 w-100 gap-3" style="background: linear-gradient(0deg, rgba(255,255,255,0.05) 0%, rgba(255,255,255,0.05) 100%), var(--secondary-background)">
                        <div class="fw-bold"><img src="https://img.pay4d.info/kontak/fb.png" width='20px'></div>
                        <div style="color: var(--text-color); font-size: 1.1rem"><?php echo FB_ADMIN; ?></div>
                    </div>
        ...
        <div class="mobile-only" style="position: relative; background: var(--primary-background);">
            <div class="appbar">
                <a href="./" style="width: auto"><img class="logoimg" src="secure_admin/<?php echo WEBSITE_LOGO ?>" alt=""></a>
        ...
        <header class="header">
            <div class="header-content">
                <div class="logo" href="./">
                    <a href="./"><img src="secure_admin/<?php echo WEBSITE_LOGO ?>?34537" class="logoimg" alt=""></a>
                </div>
                ...
                <div id="marquee-mobile" class="marquee mobile-only">
                    <div class="marquee-content">
                        ...
                        <div class="running">
                            ...
                            <marquee behavior="scroll" direction="" id="broadcast" style="width: 100%"><?PHP echo MARQ ?></marquee>
                        </div>
                        <div class="d-flex align-items-center gap-2">
                        </div>
                    </div>
              ...
              <img src="banner/' . $banner['image_path'] . '" alt="' . $banner['alt_text'] . '" class="d-block w-100">
            </div>';
                                    $active = '';
                                }
                                ?>
                ...
                <div class="login">
                    <div class="desktop-only">
                        <form id="loginFormDesktop" class="login-form form" role="form">
                            <div id="msgboxDesktop" style="margin-right: 8px; color: #b29459; font-size: 1rem"></div>
                            ...
                            <div class="input-group login-field">
                                ...
                                <input type="text" name="regUSER" id="regUSER" class="form-control login-input-field username" placeholder="Nama Akun" aria-label="Username">
                            </div>
                            <div id="marquee" class="marquee mobile-only">
                                <div class="marquee-content">
                                    ...
                                    <div class="running">
                                        <div class="marquee-shadow"></div>
                                        <marquee behavior="" direction="" id="broadcast"><?PHP echo MARQ ?></marquee>
                                    </div>
                                </div>
                            </div>
                            <div class="input-group login-field">
                                ...
                                <input type="password" name="regPW" id="regPW" class="form-control login-input-field password" placeholder="Kata Sandi" aria-label="Password">
                            </div>
                            <input type="submit" value="Masuk" class="btn btn-masuk fw-bold p-0 px-2 submit">
                    ...
                    <!-- INI LOGIN FORM -->
                    <div id="" class="mobile-only" style="width: 100%">
                        <form id="loginForm" class="login-form form" style="padding: 0px; padding-top: 32px" role="form">
                            ...
                            <div class="input-group login-field">
                                ...
                                <input type="text" name="username" id="username" class="form-control login-input-field username" placeholder="Username" autocomplete="off" aria-label="Username">
                            </div>
                            <div class="input-group login-field">
                                <span class="input-group-text mobile-only prepend">
                                    <div class="h-100 center"><i class="bi bi-shield-lock-fill prepend-icon"></i></div>
                                </span>
                                <input type="password" name="password" id="password" class="form-control login-input-field password" placeholder="Password" autocomplete="off" aria-label="Password">
                            </div>
                    ...
                    <div id="mobile-daftar-form" style="width: 100%; display: none">
                        <div id="">
                            <form id="registerForm" class="login-form  p-0 pt-4">
                                ...
                                <div class="input-group login-field">
                                    ...
                                    <input type="text" class="form-control login-input-field" id="regUsername" placeholder="Username 6-16 karakter standar (A~Z, a~z, 0~9) dan tanpa spasi">
                                </div>
                                <div class="input-group login-field">
                                    <span class="input-group-text mobile-only prepend">
                                        <div class="h-100 center"><i class="bi bi-shield-lock-fill prepend-icon"></i></div>
                                    </span>
                                    <input type="password" class="form-control login-input-field" id="regPassword" placeholder="Password (6 karakter atau lebih)">
                                </div>
                                <div class="input-group login-field">
                                    <span class="input-group-text mobile-only prepend">
                                        <div class="h-100 center"><i class="bi bi-shield-lock-fill prepend-icon"></i></div>
                                    </span>
                                    <input type="password" class="form-control login-input-field" id="regConfirmPassword" placeholder="Password sekali lagi">
                                </div>
                                <div class="input-group login-field">
                                    <span class="input-group-text mobile-only prepend">
                                        <div class="h-100 center"><i class="bi bi-envelope-fill prepend-icon"></i></div>
                                    </span>
                                    <input type="text" class="form-control login-input-field" id="email" placeholder="Email">
                                </div>
                                <div class="input-group login-field">
                                    <span class="input-group-text mobile-only prepend">
                                        <div class="h-100 center"><i class="bi bi-telephone-fill prepend-icon"></i></div>
                                    </span>
                                    <input type="text" inputmode="numeric" class="form-control login-input-field" id="regTelp" class="form-control" placeholder="Telpon">
                                </div>

                                <div class="input-group login-field">
                                    <select class="form-select login-input-field" id="regBank">
                                ...
                                <div class="input-group login-field">
                                    ...
                                    <input type="text" class="form-control login-input-field" id="regAcc" placeholder="No Rekening">
                                </div>
                                <div class="input-group login-field">
                                    <span class="input-group-text mobile-only prepend">
                                        <div class="h-100 center"><i class="bi bi-person-fill prepend-icon"></i></div>
                                    </span>
                                    <input type="text" class="form-control login-input-field" id="regName" placeholder="Nama Rekening">
                                </div>
                                <div class="input-group login-field">
                                    <span class="input-group-text mobile-only prepend">
                                        <div class="h-100 center"><i class="bi bi-file-earmark-person-fill prepend-icon"></i></div>
                                    </span>
                                    <input type="text" class="form-control login-input-field" type="text" id="reg_ref" placeholder="Username Referal bila ada">
                                </div>
                               


                                <button type="submit" class="btn btn-masuk fw-bold p-0 px-2" value="Register">Register</button>
        ...
        <div id="marquee" class="marquee desktop-only">
            <div class="marquee-content">
                ...
                <div class="running" style="padding-left: 8px; padding-right: 32px">
                    <marquee behavior="" direction="" id="broadcast" onmouseover="this.stop();" onmouseout="this.start();" style="width: 100%"><?php echo MARQ ?></marquee>
                </div>
                <div class="d-flex align-items-center gap-2">
        ...
        <div class="contentdata">
            <div id="content-primary" class="p-0">
                ...
                if ($content === 'hasil') {
                    if ($pid === 'SG') {
                        include 'togeldesktop/hasil-sg.php';
                    } elseif ($pid === 'SKA') {
                        include 'togeldesktop/hasil-ska.php';
                    } elseif ($pid === 'SKT') {
                        include 'togeldesktop/hasil-skt.php';
                    } elseif ($pid === 'SKD') {
                        include 'togeldesktop/hasil-skd.php';
                    } elseif ($pid === 'MY') {
                        include 'togeldesktop/hasil-my.php';
                    } elseif ($pid === 'TWH') {
                        include 'togeldesktop/hasil-twh.php';
                    } elseif ($pid === 'HKD') {
                        include 'togeldesktop/hasil-hkd.php';
                    }
                } elseif ($content === 'slot' && $provider === 'pp') {
                    include 'gamesdesktop/slot/pp.php';
                } elseif ($content === 'slot' && $provider == 'pg') {
                    include 'gamesdesktop/slot/pg.php';
                } elseif ($content === 'slot' && $provider == 'hb') {
                    include 'gamesdesktop/slot/hb.php';
                } elseif ($content === 'slot' && $provider == 'jg') {
                    include 'gamesdesktop/slot/jg.php';
                } elseif ($content === 'slot' && $provider == 'sg') {
                    include 'gamesdesktop/slot/sg.php';
                } elseif ($content === 'slot' && $provider == 'jl') {
                    include 'gamesdesktop/slot/jl.php';
                } elseif ($content === 'slot' && $provider == 'fs') {
                    include 'gamesdesktop/slot/fs.php';
                } elseif ($content === 'slot' && $provider == 'ps') {
                    include 'gamesdesktop/slot/ps.php';
                } elseif ($content === 'slot' && $provider == 'cq9') {
                    include 'gamesdesktop/slot/cq9.php';
                } elseif ($content === 'slot' && $provider == 'mg') {
                    include 'gamesdesktop/slot/mg.php';
                } elseif ($content === 'slot' && $provider == 'ttg') {
                    include 'gamesdesktop/slot/ttg.php';
                } elseif ($content === 'casino' && $provider == 'pplc') {
                    include 'gamesdesktop/casino/pplc.php';
                } elseif ($content === 'casino' && $provider == 'ion') {
                    include 'gamesdesktop/casino/ion.php';
                } elseif ($content === 'casino' && $provider == 'evo') {
                    include 'gamesdesktop/casino/evo.php';
                } elseif ($content === 'casino' && $provider == 'sx') {
                    include 'gamesdesktop/casino/sx.php';
                } elseif ($content === 'casino' && $provider == 'ab') {
                    include 'gamesdesktop/casino/ab.php';
                } elseif ($content === 'casino' && $provider == 'jl') {
                    include 'gamesdesktop/casino/jl.php';
                } elseif ($content === 'casino' && $provider == 'mg') {
                    include 'gamesdesktop/casino/mg.php';
                } elseif ($content === 'casino' && $provider == 'og') {
                    include 'gamesdesktop/casino/og.php';
                } elseif ($content === 'casino' && $provider == 'sbol') {
                    include 'gamesdesktop/casino/sbol.php';
                } elseif ($content === 'fish' && $provider == 'sg') {
                    include 'gamesdesktop/fish/sg.php';
                } elseif ($content === 'fish' && $provider == 'jl') {
                    include 'gamesdesktop/fish/jl.php';
                } elseif ($content === 'fish' && $provider == 'fs') {
                    include 'gamesdesktop/fish/fs.php';
                } elseif ($content === 'fish' && $provider == 'ps') {
                    include 'gamesdesktop/fish/ps.php';
                } elseif ($content === 'slot') {
                    include 'gamesdesktop/slot/pp.php';
                } elseif ($content === 'casino') {
                    include 'gamesdesktop/casino/pplc.php';
                } elseif ($content === 'sport') {
                    include 'gamesdesktop/sport/sport.php';
                } elseif ($content === 'fish') {
                    include 'gamesdesktop/fish/fish.php';
                } elseif ($content === 'sabung') {
                    include 'gamesdesktop/sabung/sabung.php';
                } elseif ($content === 'register') {
                    include 'desktop/content-register.php';
                } elseif ($content === 'event') {
                    include 'desktop/event.php';
                } elseif ($content === 'promosi') {
                    include 'desktop/content-promosi.php';
                } elseif ($content === 'promo') {
                    include 'm/promosi.php';
                ...
                <div class="mobile-only">
                    <div class="banner shadow" style="margin:20px 20px 20px 20px; border:solid 2px #FFF; border-radius: 20px; box-shadow:rgba(0,0,0,1) 0px 0px 10px 0px; position: relative;">
                        ...
                        <img src="banner/<?php echo BANNER_MOBILE_HOME ?>" alt="<?php echo WEBSITE_NAME; ?>" style="border-radius: 20px; top: 0; left: 0; width: 100%; height: 100%; position: absolute;">
                    </div>
                    <div class="banner shadow" style="margin:20px 20px 20px 20px; border:solid 2px #FFF; border-radius: 20px; box-shadow:rgba(0,0,0,1) 0px 0px 10px 0px; position: relative;">
        ...
        <div id="togel-desktop" class="togel-desktop desktop-only">
            ...
            <?php
            // Fungsi untuk mengubah format tanggal menjadi "Hari dd/M/yyyy"
            function formatTanggal($tanggal)
            {
                ...
                $tanggalFormatted = date('d/n/Y', strtotime($tanggal));
                return $hariIndo . ' ' . $tanggalFormatted;
            }

            // Mendapatkan waktu sekarang
            $waktuSekarang = date('Y-m-d');
            $waktuFormatted = formatTanggal($waktuSekarang);
            ?>
            ...
            <div class="togel-content ">
                <a href="?content=hasil&amp;pid=SG" class="result">
                    ...
                    <div class="keluaran"><?php echo TOGEL_SINGAPORE ?></div>
                    <div class="tanggal"><?php echo $waktuFormatted; ?></div>
                </a>
                <a href="?content=hasil&amp;pid=SKA" class="result">
                    ...
                    <div class="pasaran">SAKA POOLS&nbsp;</div>
                    <div class="keluaran"><?php echo TOGEL_SAKAPOOLS ?></div>
                    <div class="tanggal"><?php echo $waktuFormatted; ?></div>
                </a>
                <a href="?content=hasil&amp;pid=SKT" class="result">
                    ...
                    <div class="pasaran">SAKA TOTO&nbsp;</div>
                    <div class="keluaran"><?php echo TOGEL_SAKATOTO ?> </div>
                    <div class="tanggal"><?php echo $waktuFormatted; ?></div>
                </a>
                <a href="?content=hasil&amp;pid=SKD" class="result">
                    ...
                    <div class="pasaran">SAKA 4D&nbsp;</div>
                    <div class="keluaran"><?php echo TOGEL_SAKA4D ?></div>
                    <div class="tanggal"><?php echo $waktuFormatted; ?></div>
                </a>
                <a href="?content=hasil&amp;pid=MY" class="result">
                    ...
                    <div class="keluaran"><?php echo TOGEL_MALAYSIA ?></div>
                    <div class="tanggal"><?php echo $waktuFormatted; ?></div>
                </a>
                <a href="?content=hasil&amp;pid=TWH" class="result">
                    ...
                    <div class="keluaran"><?php echo TOGEL_TOTOWUHAN ?></div>
                    <div class="tanggal"><?php echo $waktuFormatted; ?></div>
                </a>
                <a href="?content=hasil&amp;pid=HKD" class="result">
                    ...
                    <div class="keluaran"><?php echo TOGEL_HKSIANG ?></div>
                    <div class="tanggal"><?php echo $waktuFormatted; ?></div>
                </a>
        ...
        <div id="togel-mobile" class="togel-mobile mobile-only">
            ...
            <div class="carousel slide p-0 pointer-event" data-bs-ride="carousel" style="">
                    ...
                    <div class="carousel-item accordion accordion-flush active">
                        <div class="result-data accordion-item">
                            <button class="result accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#paito-SG">
                                ...
                                <div class="pasaran">SINGAPORE&nbsp;</div>
                                <div class="keluaran"><?php echo TOGEL_SINGAPORE ?></div>
                                <div class="tanggal"><?php echo $minnolFormatted ?></div>
                            </button>
                            <div id="paito-SG" class="accordion-collapse collapse">

                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">3785</div>
                                    <div class="tanggal"><?php echo $minsatuFormatted ?></div>
                                </div>

                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">6170</div>
                                    <div class="tanggal"><?php echo $minduaFormatted ?></div>
                                </div>

                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">9878</div>
                                    <div class="tanggal"><?php echo $mintigaFormatted ?></div>
                                </div>

                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">8287</div>
                                    <div class="tanggal"><?php echo $minempatFormatted ?></div>
                                </div>

                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">9480</div>
                                    <div class="tanggal"><?php echo $minlimaFormatted ?></div>
                                </div>

                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">0363</div>
                                    <div class="tanggal"><?php echo $minenamFormatted ?></div>
                                </div>

                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">4232</div>
                                    <div class="tanggal"><?php echo $mintujuhFormatted ?></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="result-data accordion-item">
                            ...
                            <div id="paito-SKA" class="accordion-collapse collapse">
                                ...
                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">4943</div>
                                    <div class="tanggal"><?php echo $minsatuFormatted ?></div>
                                </div>

                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">5613</div>
                                    <div class="tanggal"><?php echo $minduaFormatted ?></div>
                                </div>

                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">7080</div>
                                    <div class="tanggal"><?php echo $mintigaFormatted ?></div>
                                </div>
                        ...
                        <div class="result-data accordion-item">
                            ...
                            <div id="paito-SKT" class="accordion-collapse collapse">
                                ...
                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">5460</div>
                                    <div class="tanggal"><?php echo $minsatuFormatted ?></div>
                                </div>

                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">6925</div>
                                    <div class="tanggal"><?php echo $minduaFormatted ?></div>
                                </div>

                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">5847</div>
                                    <div class="tanggal"><?php echo $mintigaFormatted ?></div>
                                </div>

                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">4633</div>
                                    <div class="tanggal"><?php echo $minempatFormatted ?></div>
                                </div>
                                ...
                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">2318</div>
                                    <div class="tanggal"><?php echo $minenamFormatted ?></div>
                                </div>

                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">2668</div>
                                    <div class="tanggal"><?php echo $mintujuhFormatted ?></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="result-data accordion-item">
                            ...
                            <div id="paito-SKD" class="accordion-collapse collapse">
                                ...
                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">6589</div>
                                    <div class="tanggal"><?php echo $minempatFormatted ?></div>
                                </div>

                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">9605</div>
                                    <div class="tanggal"><?php echo $minlimaFormatted ?></div>
                                </div>

                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">3689</div>
                                    <div class="tanggal"><?php echo $minenamFormatted ?></div>
                                </div>

                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">0889</div>
                                    <div class="tanggal"><?php echo $mintujuhFormatted ?></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="result-data accordion-item">
                            ...
                            <div id="paito-MY" class="accordion-collapse collapse">
                                ...
                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">3231</div>
                                    <div class="tanggal"><?php echo $minduaFormatted ?></div>
                                </div>

                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">5502</div>
                                    <div class="tanggal"><?php echo $mintigaFormatted ?></div>
                                </div>

                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">4303</div>
                                    <div class="tanggal"><?php echo $minempatFormatted ?></div>
                                </div>
                                ...
                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">7022</div>
                                    <div class="tanggal"><?php echo $minenamFormatted ?></div>
                                </div>

                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">4697</div>
                                    <div class="tanggal"><?php echo $mintujuhFormatted ?></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="result-data accordion-item">
                            ...
                            <div id="paito-TWH" class="accordion-collapse collapse">
                                ...
                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">8513</div>
                                    <div class="tanggal"><?php echo $minlimaFormatted ?></div>
                                </div>

                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">9859</div>
                                    <div class="tanggal"><?php echo $minenamFormatted ?></div>
                                </div>
                        ...
                        <div class="result-data accordion-item">
                            ...
                            <div id="paito-HKD" class="accordion-collapse collapse">
                                ...
                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">5695</div>
                                    <div class="tanggal"><?php echo $mintigaFormatted ?></div>
                                </div>

                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">8747</div>
                                    <div class="tanggal"><?php echo $minempatFormatted ?></div>
                                </div>

                                <div class="result">
                                    <div class="pasaran"></div>
                                    <div class="keluaran">6638</div>
                                    <div class="tanggal"><?php echo $minlimaFormatted ?></div>
                                </div>
                                    ...
                                    <div>
                                        ...
                                        <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 12px">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <div style="line-height: .9rem; color: var(--primary-text-color)"><?php echo WA_ADMIN ?></div>
                                        ...
                                        <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 12px">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <div style="line-height: .9rem; color: var(--primary-text-color)"><?php echo LINE_ADMIN; ?></div>
                                        ...
                                        <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 12px">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <div style="line-height: .9rem; color: var(--primary-text-color)"><?php echo WECHAT_ADMIN; ?></div>
                                        ...
                                        <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 12px">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <div style="line-height: .9rem; color: var(--primary-text-color)"><?php echo TELEGRAM_ADMIN; ?></div>
                                    ...
                                    <div>
                                        ...
                                        <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 12px">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <div style="line-height: .9rem; color: var(--primary-text-color)"><?php echo FB_ADMIN; ?></div>
        ...
        <div class="bantuan">
            <ul class="bantuan-content" style="font-size: 1.1rem">
                <li class="bantuan-item"><a href="content-tentang.php">TENTANG KAMI</a></li>
                <div class="bantuan-devider desktop-only">|</div>
                <li class="bantuan-item"><a href="content-bantuan.php">BANTUAN</a></li>
                <div class="bantuan-devider desktop-only">|</div>
                <li class="bantuan-item"><a href="content-peraturan.php">PERATURAN</a></li>
                <div class="bantuan-devider desktop-only">|</div>
                <li class="bantuan-item"><a href="content-bank.php">INFORMASI BANK</a></li>
                <div class="bantuan-devider desktop-only">|</div>
                <li class="bantuan-item"><a href="content-hubungi.php">HUBUNGI KAMI</a></li>
                <div class="bantuan-devider desktop-only">|</div>
                <li class="bantuan-item"><a href="content-privasi.php">KEBIJAKAN PRIVASI</a></li>
                <div class="bantuan-devider desktop-only">|</div>
                <li class="bantuan-item"><a href="content-cookies.php">PERSETUJUAN COOKIES</a></li>
            </ul>
        </div>
                ...
                <div class="ptsans" style="font-size: 1rem; background: white; border-radius: 0px 5px 5px 5px; overflow: hidden; width: 160px">
                    ...
                    <div id="kontak-content" style="display: flex; flex-direction: column; width: 100%; font-size: .8rem">
                        ...
                        <div style="padding: 4px; display: flex; align-items: center; gap: 8px; border-bottom: 1px solid #e0e0e0">
                            <img src="https://img.pay4d.info/kontak/wa.png" width="20" /><span><?php echo WA_ADMIN ?></span>
                        </div>
                        <div style="padding: 4px; display: flex; align-items: center; gap: 8px; border-bottom: 1px solid #e0e0e0">
                            <img src="https://img.pay4d.info/kontak/line.png" width="20" /><span><span>ID:</span><?php echo LINE_ADMIN; ?></span>
                        </div>
                        <div style="padding: 4px; display: flex; align-items: center; gap: 8px; border-bottom: 1px solid #e0e0e0">
                            <img src="https://img.pay4d.info/kontak/wechat.png" width="20" /><span><span>ID:</span><?php echo WECHAT_ADMIN; ?></span>
                        </div>
                        <div style="padding: 4px; display: flex; align-items: center; gap: 8px; border-bottom: 1px solid #e0e0e0">
                            <img src="https://img.pay4d.info/kontak/telegram.png" width="20" /><span><span></span><?php echo TELEGRAM_ADMIN; ?></span>
                        </div>
                        <div style="padding: 4px; display: flex; align-items: center; gap: 8px; border-bottom: 1px solid #e0e0e0">
                            <img src="https://img.pay4d.info/kontak/fb.png" width="20"><span><?php echo FB_ADMIN; ?></span>
                        </div>
    ...
    <script>
        ...
        function showProviderSlot(type) {
            ...
            $('#main-content').load("mobilecontent/new-showprovider-slot.php?type=" + type);
        }

        function showProviderLiveCasino(type) {
            $('#main-content').html("<div style='padding: 24px'><img src=\"images/loading.gif\" width=\"36px\"><div>");
            $('#main-content').load("mobilecontent/new-showprovider-livecasino.php?type=" + type);
        }

        function showProvidersport(type) {
            $('#main-content').html("<div style='padding: 24px'><img src=\"images/loading.gif\" width=\"36px\"><div>");
            $('#main-content').load("mobilecontent/new-showprovider-sport.php?type=" + type);
        }

        function showProviderarcade(type) {
            $('#main-content').html("<div style='padding: 24px'><img src=\"images/loading.gif\" width=\"36px\"><div>");
            $('#main-content').load("mobilecontent/new-showprovider-arcade.php?type=" + type);
        }

        function showProvidersabung(type) {
            $('#main-content').html("<div style='padding: 24px'><img src=\"images/loading.gif\" width=\"36px\"><div>");
            $('#main-content').load("mobilecontent/new-showprovider-sabung.php?type=" + type);
        }
    ...
    <script src="logindesktop.js"></script>
    <script src="registerdesktop.js"></script>
