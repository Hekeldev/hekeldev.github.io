...
function getData() {
  $.ajax({
    url: "new-webdata.php?content=data",
...
function getLoginForm() {
  $.ajax({
    url: "new-webdata.php?content=mobilelogin",
    success: function (result) {
      $("#mobilelogin").html(result);
    },
  });
  $.ajax({
    url: "new-webdata.php?content=desktoplogin",
    success: function (result) {
...
function getOther() {
  $.ajax({
    url: "new-webdata.php?content=mobileapp",
    success: function (result) {
      $("#mobileapp").html(result);
    },
  });
  $.ajax({
    url: "new-webdata.php?content=desktopapp",
    success: function (result) {
...
function getMimpi() {
  ...
  $.ajax({
    url: "new-webdata.php?task=mimpi&dimensi=" + dimensi + "&search=" + searchs,
    success: function (result) {
...
function getTimeNow() {
  $.ajax({
    url: "new-webdata.php?status=time",
    success: function (result) {
      var listHari = [
        "Minggu",
        "Senin",
...
$(document).on("click", "#desktopregister #buttonRegister", function () {
  var ver =
    '<img src="capreg.php" width="100%" height="30" style="border:1px #999 solid;">';
    ...
    function (data) {
      ...
      if (data == "success") {
        ...
        $("#desktopregister #statusRegister")
          .removeClass()
          .addClass("alert alert-sm alert-warning")
          .text("Maaf ada masalah dengan registrasi")
          .fadeIn(1000);
        ...
        $("#desktopregister #statusRegister")
          ...
          .fadeIn(1000);
        $("#desktopregister #input-rek").addClass("has-error");
      } else if (data == "refError") {
        $("#desktopregister #statusRegister")
          .removeClass()
          .addClass("alert alert-sm alert-warning")
          .text(
            "Maaf tidak ada referal tersebut, bila tidak punya referal, bisa kosongkan"
          )
          .fadeIn(1000);
        $("#desktopregister #input-ref").addClass("has-error");
        $("#desktopregister #reg_ref").removeAttr("readonly").val("");
      ...
      } else if (data == "lainEmpty") {
        $("#desktopregister #statusRegister")
          .removeClass()
          .addClass("alert alert-sm alert-warning")
          .text("Maaf mohon diisi kolom lain-lain")
          .fadeIn(1000);
...
function register() {
  ...
  $.ajax({
    url: "new-webdata.php?content=register",
    success: function (result) {
...
function getStatusMaintenance() {
  $.ajax({
    url: "new-webdata.php?status=maintenance",
    success: function (result) {
      if (result == "1") {
...
function pagepromo() {
  $("#desktop #content").html('<img src="images/loading.gif" width="50">');
  $.ajax({
    url: "new-webdata.php?content=cms&page=promo",
    success: function (result) {
      $("#desktop #content").html(result);
      $("#desktop #content").fadeIn(500);
      hideSlide();
...
function page(i) {
  ...
  $.ajax({
    url: "new-webdata.php?content=cms&page=" + i,
    success: function (result) {
...
function resultData(id, i) {
  ...
  $("#desktop #content").html('<img src="images/loading.gif" width="50">');
  $.ajax({
    url: "new-webdata.php?content=hasil&pid=" + id + "&page=" + i,
    success: function (result) {
      $("#desktop #content").html(result);
      $("#desktop #content").fadeIn(500);
    },
...
function dataPasaran() {
  $.ajax({
    url: "new-webdata.php?content=dataPasaran",
    success: function (result) {
...
function getBroadcast() {
  $.ajax({
    url: "new-webdata.php?content=broadcast",
    success: function (result) {
...
function getLucky() {
  $.ajax({
    url: "new-webdata.php?content=lucky",
    success: function (result) {
      $("#lucky").html(result);
    },
  });
...
function getLastDepo() {
  $.ajax({
    url: "new-webdata.php?content=lastDepo",
    success: function (result) {
...
function getLastWD() {
  $.ajax({
    url: "new-webdata.php?content=lastWD",
    success: function (result) {
      $("#lastWD").html(result);
    },
  });
...
$(document).on("click", "#mobileregister #buttonRegister", function () {
  var ver =
    '<img src="m/capreg.php" width="100%" style="height: 40px; width: 100%; border-radius: 5px;margin-top: -3px;">';
    ...
    function (data) {
      ...
      if (data == "success") {
        ...
        $("#mobileregister #statusRegister")
          .removeClass()
          .addClass("alert alert-sm alert-warning")
          .text("Maaf tidak ada referal tersebut")
          .fadeIn(1000);
...
function mregister() {
  ...
  $.ajax({
    url: "m/mwebdata.php?content=register",
    success: function (result) {
