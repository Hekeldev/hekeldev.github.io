...
<h2 style="margin-bottom:30px;"><img src="https://img.pay4d.info/mg2.png" alt="" style="margin-top:-20px; height:50px; margin-right: 10px;">Microgaming</h2><div class="slotarea">                    <figure class="gameitem">
                    <img src="https://img.pay4d.info/mg/images/smg_magicjokers_icon_square_250x250_en.png">
                    <figcaption style="text-align:center; margin-top:5px;cursor:pointer">Magic Jokers</figcaption>
                    </figure>

                                        <figure class="gameitem">
                    <img src="https://img.pay4d.info/mg/images/smg_fishemup_icon_square_250x250_en.png">
                    <figcaption style="text-align:center; margin-top:5px;cursor:pointer">Fish 'Em Up</figcaption>
                    </figure>
                    ...
                    <figcaption style="text-align:center; margin-top:5px;cursor:pointer">Bolt X UP</figcaption>
                    </figure>
