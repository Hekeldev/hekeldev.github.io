                    ...
                    <div class="togel-desktop desktop-only" id="informasi-content" style="display: inline-block; text-align: left; margin:20px 20px 20px 20px; border:solid 2px #FFF; border-radius: 20px; box-shadow:rgba(0,0,0,1) 0px 0px 10px 0px; position: relative;">
                        ...
                        <div style="margin: 32px 0; height:600px; overflow: auto; z-index:1;" id="content2">
                            ...
                            <div id="informasi-content-text">
                                <div id="informasi-content-title">Tentang</div>

                                <div id="informasi-content-info">
                                    DAVO88 hadir untuk melayani para pecinta slot dan togel di seluruh Indonesia.<br><br>
                                    DAVO88 hanya menyelenggarakan Lottery dari negara-negara yang menyediakan hasil lottery yang legal dan sah seperti SINGAPORE, HONGKONG dan SYDNEY.<br><br>
                                    DAVO88 telah beroperasi sejak tahun 2015 dengan menyelenggarakan pembukaan account Taruhan Togel yang dilakukan secara online.<br><br>
                                    Kami berkomitmen untuk memberikan pelayanan terbaik dan memuaskan kepada seluruh member kami dengan di dukung oleh staff kami yang profesional dan handal yang menjadikan DAVO88 sebagai agen judi Slot dan Togel online terbaik dan terpercaya saat ini.<p></p>
                                </div>
                            </div>
                        </div>
                    </div>
