...
if (isset($_POST['register'])) {
    ...
    if (mysqli_num_rows($resultCheckUsername) > 0) {
        $response = array('status' => 'usernameWrong');
    } elseif (mysqli_num_rows($resultCheckEmail) > 0) {
        $response = array('status' => 'emailError');
    } elseif (mysqli_num_rows($resultCheckTelp) > 0) {
        $response = array('status' => 'telponExist');
    } elseif (mysqli_num_rows($resultCheckNorek) > 0) {
        $response = array('status' => 'rekExist');
    } else {
...
<head>
    ...
    <meta name="keywords" content="<?php echo WEBSITE_NAME; ?>, <?php echo WEBSITE_NAME; ?> daftar, <?php echo WEBSITE_NAME; ?> link, <?php echo WEBSITE_NAME; ?> login, situs <?php echo WEBSITE_NAME; ?>, link alternatif <?php echo WEBSITE_NAME; ?>, slot <?php echo WEBSITE_NAME; ?>, situs judi <?php echo WEBSITE_NAME; ?>, agen <?php echo WEBSITE_NAME; ?>, bandar davo88" />
    ...
    <link rel="stylesheet" href="css/light.css?35644">
        <!-- Pastikan Anda telah menyertakan file SweetAlert -->
...
<body id="desktop">
    ...
    <div id="top" class="wrapper">
                ...
                <div class="login">
                    ...
                    <script>
                        $(document).ready(function() {
                            // Memberikan event click pada gambar captcha
                            $('#captchaImg').on('click', function() {
                                refreshCaptcha();
                            });

                            // Fungsi untuk memperbarui gambar captcha dengan AJAX
                            function refreshCaptcha() {
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        $('#captchaImg').attr('src', 'data:image/png;base64,' + response);
                                    },
                    ...
                    <div id="mobilelogin" class="mobile-only" style="width: 100%">
                        <form class="login-form form" style="padding: 0px; padding-top: 32px" role="form">
                            ...
                            <div class="verifikasiform w-100" style="display: flex; gap: 2px">
                                ...
                                <span id="refreshButton"><img src="" width="40" height="40" style="border:1px #999 solid;"></span>
                            ...
                            <input type="hidden" name="loginmobile" value="Hh33ERs7uk5NNiIqnvvytA/odgK2G2UiQbeJzkIL3fo=">
                        </form>
                    </div>



                    <div id="mobile-daftar-forms" style="width: 100%; display: none">
                        <div id="">
        ...
        <div id="marquee" class="marquee desktop-only">
            <div class="marquee-content">
                <div class="d-flex align-items-center gap-2">
                    <div id="waktu_sekarang" class="desktop-only" style="white-space: nowrap;">JAMTANGGAL</div>
                    <i class="bi bi-megaphone-fill desktop-only"></i>
                </div>
                ...
                <div class="d-flex align-items-center gap-2">
                    <a href="<?php echo WEBSITE_NAME; ?>content-event.php">
                        ...
                        <div id="content" class="content-box">
                            ...
                            <div id="desktopregister" class="panel panel-default panelbg ptsans">
                                <div class="panel-body panelbg">
                                    ...
                                    <form method="post"  class="form-group-sm" id="formRegister">
                                        ...
                                        <div class="form-group-sm" id="input-username">
                                            <label>Username</label><input type="text" class="form-control has-success" name="username" placeholder="Username 6-16 karakter standar (A~Z, a~z, 0~9) dan tanpa spasi">
                                        </div>
                                        <div class="row" style="margin-top:10px">
                                            <div class="form-group-sm col-md-3" id="input-pass">
                                                <label>Password</label><input type="password" name="password" class="form-control" placeholder="Password (6 karakter atau lebih)">
                                            </div>
                                            <div class="form-group-sm col-md-3" id="input-passcon">
                                                <label>Konfirmasi Password</label><input type="password" name="password2" class="form-control" placeholder="Password sekali lagi">
                                            </div>
                                            <div class="form-group-sm col-md-3" id="input-email">
                                                <label>Email</label><input type="text" name="email" class="form-control" placeholder="Masukkan Email">
                                            </div>
                                            <div class="form-group-sm col-md-3" id="input-telpon">
                                                <label>Telpon</label><input type="text" inputmode="numeric" name="telp_no" class="form-control" placeholder="Masukkan Telpon">
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top:10px">
                                            ...
                                            <div class="form-group-sm col-md-3" id="input-rek">
                                                <label>No Rekening</label><input type="text" inputmode="numeric" name="acc_no" class="form-control" placeholder="Masukkan nomor rekening">
                                            </div>
                                            <div class="form-group-sm col-md-3" id="input-nama">
                                                <label>Nama sesuai Rekening</label><input name="fullname" type="text" class="form-control" placeholder="Nama sesuai rekening">
                                            </div>
                                            <div class="form-group-sm col-md-3" id="input-ref">
                                                <label>Referal</label><input name="referral_code" type="text" class="form-control" placeholder="Username Referal bila ada">
                                            </div>
                                        </div>
                                        ...
                                        <input type="submit"  class="btn btn-masuk fw-bold" value="Daftar" id="buttonRegister" style="margin-top:20px; width:200px; text-align: center; display: grid; place-items: center; line-height: var(--text-size-default); height: 40px">
        ...
        <div id="togel-desktop" class="togel-desktop desktop-only">
            ...
            <div class="togel-content ">
                <a href="<?php echo WEBSITE_NAME; ?>?content=hasil&pid=SG" class="result">
                    ...
                    <div class="tanggal">JAMTOGEL</div>
                </a>
                <a href="<?php echo WEBSITE_NAME; ?>?content=hasil&pid=SKA" class="result">
                ...
                <a href="<?php echo WEBSITE_NAME; ?>?content=hasil&pid=SKT" class="result">
                ...
                <a href="<?php echo WEBSITE_NAME; ?>?content=hasil&pid=SKD" class="result">
        ...
        <div id="togel-mobile" class="togel-mobile mobile-only">
            ...
            <div class="carousel slide p-0" data-bs-ride="carousel" >
        ...
        <div class="bantuan">
            <ul class="bantuan-content" style="font-size: 1.1rem">
                <li class="bantuan-item"><a href="<?php echo WEBSITE_NAME; ?>content-tentang.php">TENTANG KAMI</a></li>
                <div class="bantuan-devider desktop-only">|</div>
                <li class="bantuan-item"><a href="<?php echo WEBSITE_NAME; ?>content-bantuan.php">BANTUAN</a></li>
                <div class="bantuan-devider desktop-only">|</div>
                <li class="bantuan-item"><a href="<?php echo WEBSITE_NAME; ?>content-peraturan.php">PERATURAN</a></li>
                <div class="bantuan-devider desktop-only">|</div>
                <li class="bantuan-item"><a href="<?php echo WEBSITE_NAME; ?>content-bank.php">INFORMASI BANK</a></li>
                <div class="bantuan-devider desktop-only">|</div>
                <li class="bantuan-item"><a href="<?php echo WEBSITE_NAME; ?>content-hubungi.php">HUBUNGI KAMI</a></li>
                <div class="bantuan-devider desktop-only">|</div>
                <li class="bantuan-item"><a href="<?php echo WEBSITE_NAME; ?>content-privasi.php">KEBIJAKAN PRIVASI</a></li>
                <div class="bantuan-devider desktop-only">|</div>
                <li class="bantuan-item"><a href="<?php echo WEBSITE_NAME; ?>content-cookies.php">PERSETUJUAN COOKIES</a></li>
            </ul>
        </div>
...
<img src="https://i.ibb.co/QkS16Qt/Slider-Mobile-Ramadhan.jpg" alt="" />
  ...
  <div class="slider">
    <a href="#">
      <img src="https://i.ibb.co/42P324f/Slider-Thunder-Wheel-<?php echo WEBSITE_NAME; ?>.gif" alt="" />
    </a>
  </div>
  <div class="slider">
    <a href="#">
      <img src="https://i.ibb.co/9wVQ1jy/<?php echo WEBSITE_NAME; ?>-Slider-Mobile-Akses-Lebih-Mudah.jpg" alt="" />
    </a>
  </div>
  <div class="slider">
    <a href="#">
      <img src="https://i.ibb.co/9N7fZLB/<?php echo WEBSITE_NAME; ?>-Slider-HP.jpg" alt="" />
    </a>
  </div>
    ...
    <script>
        $("<a class='btn btn-primary btn-block' style='background: rgba(66, 132, 245);border: 1px solid rgba(66, 132, 245);margin: 2px 0;' href='https://www.facebook.com/groups/<?php echo WEBSITE_NAME; ?>official' target='_blank'>Claim Event Facebook <?php echo WEBSITE_NAME; ?></a>").insertAfter(".btn-info:eq(0)")
    </script>
...
<script>
    $(document).on("click", "#desktopregister #buttonRegister", function() {
        ...
        $.post(
            "content-register.php?register",
            $("#desktopregister #formRegister").serialize(),
            function(data) {
                resetClassReg();
                data = JSON.parse(data); // Ubah ini untuk menguraikan respons JSON
                ...
                if (data.status === "success") {
                    ...
                    Swal.fire({
                        ...
                        // Redirect ke halaman lain setelah menutup SweetAlert
                        window.location.href = "halaman-lain.php";
                    });
                } else if (data.status === "usernameWrong") {
                    // Tampilkan SweetAlert kesalahan username
                    Swal.fire({
                        icon: 'error',
                    ...
                    // Tampilkan SweetAlert kesalahan email
                    Swal.fire({
                        icon: 'error',
                ...
                } else if (data.status === "telponExist") {
                    // Tampilkan SweetAlert kesalahan nomor telepon
                    Swal.fire({
                        icon: 'error',
                ...
                } else if (data.status === "rekExist") {
                    // Tampilkan SweetAlert kesalahan nomor rekening
                    Swal.fire({
                        icon: 'error',
                        title: 'Nomor Rekening Sudah Digunakan',
                        text: 'Silakan gunakan nomor rekening lain.',
                        showConfirmButton: true
                    });
                } else {
                    // Penanganan status lainnya
                    // ...
                }
            }
        );
