                    ...
                    <div class="togel-desktop desktop-only" id="informasi-content" style="display: inline-block; text-align: left; margin:20px 20px 20px 20px; border:solid 2px #FFF; border-radius: 20px; box-shadow:rgba(0,0,0,1) 0px 0px 10px 0px; position: relative;">
                        ...
                        <div style="margin: 32px 0; height:600px; overflow: auto; z-index:1;" id="content2">
                            ...
                            <div id="informasi-content-text">
                                <div id="informasi-content-title">Bantuan</div>

                                <div id="informasi-content-info">
                                    Q: Bagaimana saya membuka account di DAVO88 ?
                                    A: Pendaftaran terbuka untuk setiap orang yang berusia 18 tahun keatas, untuk membuka account DAVO88.
                                    <br><br>
                                    1. Silahkan klik REGISTER di menu website DAVO88.com
                                    2. Setelah anda login dengan menggunakan ID dan password yang anda buat, klik di menu deposit pada bagian atas, disana akan terdapat no rekening tujuan untuk deposit
                                    3. Setelah melakukan deposit, pihak Customer Service kami akan segera memprosesnya, dan balance anda akan bertambah secara otomatis
                                    4. Selanjutnya, jika akan melakukan transaksi DEPOSIT atau WITHDRAW, silahkan isi di menu yang telah kami sediakan
                                    Note : DEPOSIT /WITHDRAW menggunakan menu form " LEBIH CEPAT" dibandingkan menggunakan media lainnya.
                                    <br><br>
                                    Q: Berapa minimum deposit?
                                    A: Minimum deposit adalah Rp. 10.000,-.
                                    <br><br>
                                    Q: Berapa minimum taruhan?
                                    A: Minimum taruhan adalah Rp. 100,- untuk permainan angka 4d/3d/2d, dan Rp. 5.000,- untuk permainan lainnya
                                    <br><br>
                                    Q: Berapa maksimum taruhan?
                                    A: Nilai maksimum untuk taruhan disesuaikan dari game yang dipilih.
                                    <br><br>
                                    Q: Kapan saja saya bisa memasang taruhan?
                                    A: Anda bisa memasang disaat pasaran yang anda pilih sedang online. Harap perhatikan jam online dan offline setiap pasaran
                                    <br><br>
                                    Q: Bisakah saya membatalkan taruhan saya?
                                    A: Tidak bisa. Setelah anda mengkonfirmasi taruhan anda, taruhan anda tidak bisa di batalkan dan akan tetap di proses.
                                    <br><br>
                                    Q: Bagaimana cara saya deposit?
                                    A: Kami menerima semua transaksi deposit dari semua BANK, E-Wallet, dan Pulsa
                                    <br><br>
                                    Q: Bisakah saya melakukan deposit / withdraw dari bank lain ?
                                    A: Bisa, Untuk Deposit biaya transfer di tanggung oleh Player, kami hanya WD ke rekening yang terdaftar di ID tersebut
                                    <br><br>
                                    Q: Mengapa saya tidak bisa melakukan deposit lagi?
                                    A: Harap hubungi CS kami, ada kemungkinan permohonan deposit anda yang sebelumnya belum diproses yang dikarenakan sebab-sebab tertentu (bank offline, dana tidak masuk, DLL)
                                    <br><br>
                                    Q: Bagaimana cara saya withdraw?
                                    A: Untuk proses lebih cepat kami sarankan anda mengisi FORM WITHDRAW
                                    <br><br>
                                    Q: Mengapa saya tidak bisa withdraw disaat balance saya masi cukup ?
                                    A: Harap hubungi CS kami, ada beberapa kemungkinan seperti BANK OFFLINE, maka permohonan Withdraw yang sebelumnya anda isi belum diproses dan tidak bisa melakukan permohonan lagi (Double Form)
                                    <br><br>
                                    Q: Berapa lama uang masuk ke rekening saya setelah saya minta withdraw?
                                    A: Dalam waktu kurang dari 5 MENIT uang akan masuk ke rekening bank anda.
                                    <br><br>
                                    Q: Apakah data pribadi saya aman dengan DAVO88?
                                    A: Semua informasi yang anda masukan di DAVO88 akan sangat di rahasiakan.
                                    <br><br>
                                    Q: Kapan saya bisa melakukan withdraw / penarikan?
                                    A: Anda bisa melakukan withdraw setiap harinya 24/7, kecuali bank OFFLINE.
                                    <br><br>
                                    Q: Berapa minimum withdraw yang bisa saya tarik?
                                    A: Minimal withdraw adalah Rp. 50.000,-.
                                    <br><br>
                                    Q: Berapa kali sehari saya bisa melakukan withdraw?
                                    <br><br>
                                    A: Anda bisa melakukan withdraw dan transfer maksimal 2x sehari per pasaran yang anda pasang, Contoh: Anda pasang di pasaran Singapore, lalu anda berhak melakukan withdraw sebanyak 2x, dan setelah pasaran selanjutnya hongkong, anda pun berhak melakukan withdraw lagi sebanyak 2x JIKA ANDA ADA MELAKUKAN BETTING DI PASARAN TERSEBUT
                                    namun jika di temukan ada tindakan2 untuk mempersulit Customer Service, maka kami berhak untuk menolak permohonan anda.<p></p>
                                </div>
                            </div>
                        </div>
                    </div>
