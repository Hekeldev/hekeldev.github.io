                    ...
                    <div class="togel-desktop desktop-only" id="informasi-content" style="display: inline-block; text-align: left; margin:20px 20px 20px 20px; border:solid 2px #FFF; border-radius: 20px; box-shadow:rgba(0,0,0,1) 0px 0px 10px 0px; position: relative;">
                        ...
                        <div style="margin: 32px 0; height:600px; overflow: auto; z-index:1;" id="content2">
                            ...
                            <div id="informasi-content-text">
                                <div id="informasi-content-title">Persetujuan Cookies
</div>

                                <div id="informasi-content-info">
                                    Apakah kita menggunakan cookies?<br>
                                    Ya (Cookies adalah file berukuran kecil dalam suatu situs atau perusahaan penyedia layanan transfer ke hard drive komputer Anda
                                    melalui browser Web Anda (jika Anda mengizinkan) yang memungkinkan situs atau penyedia layanan sistem
                                    untuk mengenali browser Anda untuk menangkap maupun mengingat informasi tertentu.
                                    Kami menggunakan cookies untuk mengenali dan menyimpan preferensi Anda untuk kunjungan ke website kami
                                    selanjutnya dan untuk mengumpulkan kompilasi data tentang web traffic dan interaksi situs
                                    sehingga kita dapat mengembangkan situs yang lebih baik kedepannya.<br><br>

                                    <h3>Essential Cookie</h3>
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                <td style="width:20%">Jenis cookie</td>
                                                <td>Penjelasan</td>
                                            </tr>
                                            <tr>
                                                <td>Session </td>
                                                <td>Session cookie digunakan untuk memelihara keadaan aplikasi. </td>
                                            </tr>
                                            <tr>
                                                <td>Load balancing</td>
                                                <td>Load balancing Cookie digunakan untuk menyalurkan aset-aset di seluruh dunia dan meringankan beban server.</td>
                                            </tr>
                                            <tr>
                                                <td>ID pengguna</td>
                                                <td>Cookie ID pengguna digunakan untuk memastikan pengguna hanya melihat informasi mengenai diri mereka sendiri.</td>
                                            </tr>
                                            <tr>
                                                <td>Keamanan Cookie</td>
                                                <td>Keamanan digunakan untuk pengendalian dan pemeriksaan keamanan. </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Bahasa</td>
                                                <td>Cookie Bahasa digunakan untuk menyimpan Bahasa yang dipilih pengguna, dan untuk menunjukan pilihan yang benar.</td>
                                            </tr>
                                            <tr>
                                                <td>Lokasi</td>
                                                <td>Perkiraan alamat pengguna (kota, negara bagian, negara, kode pos)
                                                    sebagaimana ditentukan oleh alamat IP disimpan untuk secara otomatis memilih negara
                                                    dan menunjukan retailer dan hari demonstrasi dalam area tersebut. </td>
                                            </tr>
                                            <tr>
                                                <td>Mobile</td>
                                                <td>Apabila pengguna mengunjungi Situs melalui perangkat selular, cookie diatur untuk mengindikasikan
                                                    bahwa situs web utama adalah yang dipilih (yaitu bahwa perangkat Flash diaktifkan),
                                                    atau situs mobile non-Flash. </td>
                                            </tr>
                                            <tr>
                                                <td>Situs referensi</td>
                                                <td>Situs referensi dicatat untuk lebih memahami preferensi pengguna.</td>
                                            </tr>
                                            <tr>
                                                <td>Kunjungan dan kegiatan terakhir</td>
                                                <td>Tanggal kunjungan dan kegiatan terakhir dan informasi lainnya dicatat untuk dapat memberikan pengguna
                                                    kegiatan terakhir update mengenai apa saja yang berubah pada Situs sejak kunjungan terakhir, dan untuk lebih memahami preferensi pengguna</td>
                                            </tr>
                                        </tbody>
                                    </table>

                                    Bagaimana mengatur cookie ? Menerima/menolak melalui pengaturan browser.<p></p>
                                </div>
                            </div>
                        </div>
                    </div>
