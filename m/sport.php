...
<body>
	...
	<div class="container">
		...
		<ul class="nav nav-tabs grabgtab" style="margin-bottom:0px; font-size:15px; font-weight:bold; margin-top:0px;">
			...
			<li class="active" style="width:15%; text-align:center;" onClick="location.href='sport.php'"><a data-toggle="tab" href="#sport_wrap"><span><img src="https://img.pay4d.info/tab-sport-w.png" width="25" alt="" /><br>Sport</span></a>
		...
		<div class="tab-content">
			...
			<div id="sport_wrap" class="tab-pane fade in active">
				<div id="games_window_sport" class="text-center tab-pane fade in active" style="height:500px; margin-top:30px">

					<div style="height:240px; width:200px; display:inline-block; text-align:center; vertical-align:top; margin:0px auto;">
						<a href="../pay4d9-opengame.php?p=m&token=kTb3YmrISHjghvRU1OE4JpMF7VkGtkKSu3luXSkamB0%3D"><img src="https://img.pay4d.info/sabalogo.png">
							<div>Saba Sports<BR>[Rasio Credit 1:1000]</div>
						</a>
					</div>

					<div style="height:240px; width:200px; display:inline-block; text-align:center; margin:0px auto">
						<a href="../pay4d9-opengame.php?token=SnO2I02mdcMXmAhzGh%2FZjtLnr6rpQsdd62FNbXm4YLo%3D"><img src="https://img.pay4d.info/sbologo.png">
							<div>SBO Sports<BR>[Rasio Credit 1:1000]</div>
						</a>
					</div>

					<div style="height:240px; width:200px; display:inline-block; text-align:center; margin:0px auto">
						<a href="../pay4d9-opengame.php?token=duRm51Iv7u7EJqZMRCBW77bZppTjXibZsFDQjWMvog4%3D"><img src="https://img.pay4d.info/tflogo.png">
