<ul class="nav nav-tabs grabgtab" style="margin-bottom:0px; font-size:15px; font-weight:bold; margin-top:0px;">
    ...
    <li class="active" style="width:15%; text-align:center;" onClick="location.href='userarea.php?page=sport&head=home'"><a data-toggle="tab" href="#sport_wrap"><span><img src="https://img.pay4d.info/tab-sport-w.png" width="25" alt="" /><br>Sport</span></a>
  ...
  <div id="sport_wrap" class="tab-pane fade in active">
    <div id="games_window_sport" class="text-center tab-pane fade in active" style="height:500px; margin-top:30px">
      ...
      <div style="height:240px; width:200px; display:inline-block; text-align:center; vertical-align:top; margin:0px auto;">
        <a href="../pay4d9-opengame.php"><img src="https://img.pay4d.info/sabalogo.png">
      ...
      <div style="height:240px; width:200px; display:inline-block; text-align:center; margin:0px auto">
        <a href="../pay4d9-opengame.php"><img src="https://img.pay4d.info/sbologo.png">
          <div>SBO Sports<br>[Rasio Credit 1:1000]</div>
        </a>
      </div>

      <div style="height:240px; width:200px; display:inline-block; text-align:center; margin:0px auto">
        <a href="../pay4d9-opengame.php"><img src="https://img.pay4d.info/tflogo.png">
