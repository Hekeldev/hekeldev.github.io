    ...
    <div class="container">
        ...
        <div class="tab-content">
            ...
            <div id="dashboard_wrap" class="tab-pane fade in active">
                ...
                <div id="statusDeposit2"></div>
                <div id="deposit_form2">
                    <div class="panel panel-danger">
                        <div class="panel-heading">
                            <strong><span class="glyphicon glyphicon-import"></span>DETAIL DEPOSIT</strong>
                        </div>
                        <div class="panel-body">

                            <form action="../admin/functions/actions.php?aksi=konfirmasi_topup" class="form-group-sm deposit_form" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="bank" value="<?php echo $d['nama_bank']; ?>" class="form-control" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Nomor Rekening Pengirim</label>
                                    <input type="text" name="rekening" value="<?php echo $d['rek']; ?>" class="form-control" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Nama Rekening Pengirim</label>
                                    <input type="text" name="nominal" value="<?php echo $d['nama']; ?>" class="form-control" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Tanggal Deposit</label>
                                    <input type="text" name="nominal" value="<?php echo $d['date']; ?>" class="form-control" readonly>
                                </div>
                                <div class="form-group">
                                    <label>STATUS</label>
                                    <input type="text" name="nominal" value="PROGRESS" class="form-control" readonly>
                                </div>
            ...
            <a class="btn btn-primary btn-block" href="history.php" role="button" style="font-weight:bold; margin-top:20px"><span class="glyphicon glyphicon-menu-left"></span>Kembali</a>
