<?php
  $query_livechat = mysqli_query($conn, "SELECT * FROM pengaturan WHERE nama_pengaturan = 'livechat'");
  ...
  $query_line = mysqli_query($conn, "SELECT * FROM pengaturan WHERE nama_pengaturan = 'line'");
  ...
  $query_twitter = mysqli_query($conn, "SELECT * FROM pengaturan WHERE nama_pengaturan = 'twitter'");
  ...
  $query_whatsapp = mysqli_query($conn, "SELECT * FROM pengaturan WHERE nama_pengaturan = 'whatsapp'");
  ...
  $query_instagram = mysqli_query($conn, "SELECT * FROM pengaturan WHERE nama_pengaturan = 'instagram'");
  ...
  $query_facebook = mysqli_query($conn, "SELECT * FROM pengaturan WHERE nama_pengaturan = 'facebook'");
  ...
  $query_footer = mysqli_query($conn, "SELECT * FROM pengaturan WHERE nama_pengaturan = 'footer'");
  ...
  $query_livescore = mysqli_query($conn, "SELECT * FROM pengaturan WHERE nama_pengaturan = 'livescore'");
  ...
  $query_rtp_slot = mysqli_query($conn, "SELECT * FROM pengaturan WHERE nama_pengaturan = 'rtp_slot'");
  ...
  $query_popup_pengumuman = mysqli_query($conn, "SELECT * FROM pengaturan WHERE nama_pengaturan = 'popup_pengumuman'");
  ...
  $query_pusat_bantuan = mysqli_query($conn, "SELECT * FROM pengaturan WHERE nama_pengaturan = 'pusat_bantuan'");
  ...
  $query_syarat_dan_ketentuan = mysqli_query($conn, "SELECT * FROM pengaturan WHERE nama_pengaturan = 'syarat_dan_ketentuan'");
  ...
  $query_responsible_gaming = mysqli_query($conn, "SELECT * FROM pengaturan WHERE nama_pengaturan = 'responsible_gaming'");
  ...
  $query_tentang = mysqli_query($conn, "SELECT * FROM pengaturan WHERE nama_pengaturan = 'tentang'");
  ...
  $query_marquee_pengumuman = mysqli_query($conn, "SELECT * FROM pengaturan WHERE nama_pengaturan = 'marquee_pengumuman'");
  ...
  $query_logo = mysqli_query($conn, "SELECT * FROM pengaturan WHERE nama_pengaturan = 'logo'");
  $data_logo = mysqli_fetch_array($query_logo);
  $id_logo = $data_logo['id_pengaturan'];
  $isi1_logo = $data_logo['isi1_pengaturan'];

  $query_favicon = mysqli_query($conn, "SELECT * FROM pengaturan WHERE nama_pengaturan = 'favicon'");
  ...
  $query_judul_website = mysqli_query($conn, "SELECT * FROM pengaturan WHERE nama_pengaturan = 'judul_website'");
  ...
  $query_warna_utama = mysqli_query($conn, "SELECT * FROM pengaturan WHERE nama_pengaturan = 'warna_utama'");
  ...
  $query_logo_admin_light = mysqli_query($conn, "SELECT * FROM pengaturan WHERE nama_pengaturan = 'logo_admin_light'");
  ...
  $query_logo_admin_dark = mysqli_query($conn, "SELECT * FROM pengaturan WHERE nama_pengaturan = 'logo_admin_dark'");
  ...
  $query_logo_admin_sm = mysqli_query($conn, "SELECT * FROM pengaturan WHERE nama_pengaturan = 'logo_admin_sm'");
