			...
			<div id="dashboard_wrap" class="tab-pane fade in active">
				<div class="row" style="margin-bottom:0px">
					...
					<div class="col-xs-3" style="padding-right:1px; padding-left: 2px;">
						<a class="btn btn-default btn-block active" href="memo.php"><span class="glyphicon glyphicon-edit"></span>Memo<span class="badge badgeTotal" style="margin-left:5px; margin-right:10px; font-size:9px; font-weight:bold"></span></a>
					</div>
				...
				<div class="tab-content">
					<div id="memo-tulisA" class="tab-pane fade active in">
					...
					<div id="memo-inboxA" class="tab-pane fade">
						<div class="panel panel-default">
					...
					<div id="memo-sentA" class="tab-pane fade">
						<div class="panel panel-default">
							<div class="panel-heading"><strong><span class="glyphicon glyphicon-tasks"></span>Memo</strong></div>
							<div class="panel-body">
				...
				<a class="btn btn-primary btn-block" href="?statement&head=home" role="button" style="font-weight:bold; margin-top:20px"><span class="glyphicon glyphicon-menu-left"></span>Kembali</a>
				<script>
					$(document).ready(function() {
						getMemo();
					});
