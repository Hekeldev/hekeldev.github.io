			...
			<div id="dashboard_wrap" class="tab-pane fade in active">
				...
				<div class="row" style="margin-bottom:10px">
					...
					<div class="col-xs-3" style="padding-left:1px; padding-right:1px;">
						<a class="btn btn-default btn-block active" href="withdraw.php"><span class="glyphicon glyphicon-export"></span>Withdraw</a>
					</div>
						...
						<div class="panel-body">
							<form class="form-group-sm withdraw_form" method="post">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" readonly value="<?php echo $d['nama_bank']; ?> <?php echo $d['rek']; ?> <?php echo $d['nama']; ?>">

								</div>
								<div class="form-group">
									<label>Jumlah</label><input type="text" class="form-control text-right" name="jumlah" style="font-weight:bold" id="jumlah_withdraw">
								</div>
								...
								<input type="button" class="btn btn-info btn-block" id="konfirmasi_withdraw" value="Request Withdraw">
							</form>
