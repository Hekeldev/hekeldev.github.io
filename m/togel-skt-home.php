...
<div class="tab-content">
    ...
    <div id="toto_wrap" class="tab-pane fade in active">
        ...
        <div style="font-weight:bold; margin-bottom:5px; font-size:12px;">
            ...
            <span class="glyphicon glyphicon-menu-right"></span>SAKA TOTO
        </div>
        <div class="well well-sm">
            <strong>Website : </strong><a href="http://www.sakatoto.com" target="_blank">www.sakatoto.com</a><br>
            <strong>Hari Bukaan : </strong>Setiap Hari<br>
            <strong>Hari Libur : </strong>N/A<br>
            <strong>Jam Tutup : </strong>21:30 WIB <strong style="margin-left:20px">Jam Undian : </strong>22:00 WIB<br>
        </div>
        <div class="row">
