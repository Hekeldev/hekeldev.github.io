			...
			<div id="dashboard_wrap" class="tab-pane fade in active">
				...
				<div class="row" style="margin-bottom:10px">
					...
					<div class="col-xs-3" style="padding-left:2px; padding-right:1px">
						<a class="btn btn-default btn-block active" href="rekening.php"><span class="glyphicon glyphicon-briefcase"></span>Rekening<span style="position:absolute; font-size: 10px; margin-top: -8px; margin-left:-85px">&#11088;</span></a>
					</div>
					<div class="col-xs-3" style="padding-left:2px">
				...
				<div id="bank_form">
					<div class="panel panel-danger">
						<div class="panel-heading">
							<strong><span class="glyphicon glyphicon-pencil"></span>REKENING</strong>
						</div>
						<div class="panel-body" style="padding:10px">
							<div class="panel-body" id="rekenings">
									...
									<table class="table table-striped">
										<thead>
											<tr>
												...
												<th style="width:20%; text-align:center;">Rek. Withdraw</th>
											</tr>
										</thead>

										<tbody>
											<tr>
												<td><input type="text" class="form-control" value="<?php echo $d['nama_bank']; ?>" readonly=""></td>
												<td><input type="text" class="form-control" value="<?php echo $d['nama']; ?>" readonly=""></td>
												<td><input type="text" class="form-control" value="<?php echo $d['rek']; ?>" readonly=""></td>
								...
								<form class="form-group-sm addrek_form" method="post">
									<table class="table">
										...
										<tbody>
											<tr>
												<td>
													<select class="form-control" name="bankadd">
												...
												<td><input type="hidden" name="task" value="addrek"><input type="submit" id="addrek" class="btn btn-success" value="Tambah" style="width: 80px; height: 26px; padding-top: 4px"></td>
											</tr>
										</tbody>
									</table>
								</form>
