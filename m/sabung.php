...
<body>
	...
	<div class="container">
		...
		<ul class="nav nav-tabs grabgtab" style="margin-bottom:0px; font-size:15px; font-weight:bold; margin-top:0px;">
			...
			<li class="active" style="width:15%; text-align:center;" onClick="location.href='sabung.php'"><a data-toggle="tab" href="#sabung_wrap"><span><img src="https://img.pay4d.info/tab-sabung-w.png" width="25" alt="" /><br>Sabung</span></a>
		...
		<div class="tab-content">
			...
			<div id="sabung_wrap" class="tab-pane fade in active">
				<div id="games_window_sabung" class="text-center tab-pane fade in active" style="margin-top:30px">
					<div style="height:240px; width:200px; display:inline-block; text-align:center; margin:0px auto">
						<a href="../pay4d9-opengame.php?token=jBOT7kqxWFONgth7%2FcoZbgEOkmZuH94ekqaYmxB%2FSKU%3D"><img src="https://img.pay4d.info/wslogo.png">
							<div>WS168</div>
						</a>
					</div>
