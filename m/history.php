								...
								<span style="float:right; margin-top:-4px; width:245px; display:inline">
									<form class="form-group-sm">
										...
										<select class="form-control" id="historyfilter" style="width:200px; float:right">
											...
											<option value="tf">Transaksi TF eSport</option>
											<option value="ws">Transaksi WS168</option>
											...
											<option value="rtf">Referal TF eSport</option>
											<option value="rws">Referal WS168</option>
							...
							<div class="panel-body" style="font-size:11px">
								...
								<table class="table table-striped table-hover" width="100%">
									...
									foreach ($mysqli->saldo($sesi_id) as $d) {
										...
										if ($status == "konfir") {
											$button = '<a href="#' . $d['id'] . '"  title="Konfirmasi topup">' . $d['remark'] . ' </a>';
										} else if ($status == "progress") {
											$button = '<a href="#' . $d['id'] . '"  title="Konfirmasi topup">' . $d['remark'] . ' <i class="bi bi-arrow-right-square"></i></a>';
										} else if ($status == 3) {
											$button =    $d['remark'] . ' <i class="bi bi-arrow-right-square"></i></a>';
										} else if ($status == 5) {
									...
									?>
										...
										<tr onClick="">
											<td class="text-success" style="vertical-align:middle"><?php echo $d['date']; ?></td>
											<td class="text-info" style="vertical-align:middle">-</td>
											<td style="vertical-align:middle"><strong>Deposit: <?php echo $button; ?> <?php echo $nama_bank; ?> (<?php echo '' . number_format($d['nominal'], 0); ?>)</strong></td>
