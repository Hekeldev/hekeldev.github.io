...
<div class="tab-content">
    ...
    <div id="toto_wrap" class="tab-pane fade in active">
        ...
        <div style="font-weight:bold; margin-bottom:5px; font-size:12px;">
            ...
            <span class="glyphicon glyphicon-menu-right"></span>SINGAPORE
        </div>
        <div class="well well-sm">
            <strong>Website : </strong><a href="http://www.singaporepools.com" target="_blank">www.singaporepools.com</a><br>
            <strong>Hari Bukaan : </strong>Senin, Rabu, Kamis, Sabtu, Minggu<br>
            <strong>Hari Libur : </strong>Selasa, Jumat<br>
            <strong>Jam Tutup : </strong>17:20 WIB <strong style="margin-left:20px">Jam Undian : </strong>17:45 WIB<br>
        </div>
        <div class="row">
