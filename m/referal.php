			...
			<div id="dashboard_wrap" class="tab-pane fade in active">
				<div class="row" style="margin-bottom:0px">
					...
					<div class="col-xs-3" style="padding-left:2px">
						<a class="btn btn-default btn-block active" href="referal.php"><span class="glyphicon glyphicon-user"></span>Referal</a>
					</div>
				</div>
				...
				<div class="panel panel-danger">
					...
					<div class="panel-body" style="padding:10px">
						...
						Ini adalah URL referal anda: <span class="text-warning"><strong>
								...
								https://heaven4d.net/?ref=<?php echo $d['username']; ?>
							</strong></span><br>
						<br>
				...
				<a class="btn btn-primary btn-block" href="statement.php" role="button" style="font-weight:bold; margin-top:20px"><span class="glyphicon glyphicon-menu-left"></span>Kembali</a>
				<script>
