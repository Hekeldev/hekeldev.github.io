...
{	
	...
	//
	$.ajax({url: "mwebdata.php?status=time", success: function(result){
...
function freeBetApply()
{
	$('#buttonFreeBet').addClass('disabled').removeClass('btn-danger').addClass('btn-primary').attr("disabled", true);;
	
	$.ajax({url: "mdata.php?task=freebetapply", success: function(result){
		if (result == 'failed')
		{
			alert('Maaf, Anda sudah pernah dapat Promo ini');
			$('#buttonFreeBet').removeClass('disabled').removeClass('btn-primary').addClass('btn-danger').attr("disabled", false);;
		}
		else
		{
			$('#buttonFreeBet').addClass('disabled').removeClass('btn-danger').addClass('btn-primary').attr("disabled", true);;
			alert('Promo berhasil ditambahkan ke Credit Anda!');
			getCredit();
		}
	}});
}
...
function checkIP()
{
	$.ajax({url: "mdata.php?task=checkIP", success: function(result){
		if (result != "go")
		{
			quit();
		}			
...
{
	$.ajax({url: "mdata.php?task=checkLastLogin", success: function(result){
		if (result != "go")
		{
			quit();
		}			
...
function checkIPPro()
{
	$.ajax({url: "mdata.php?task=checkIPPro", success: function(result){
		if (result == "stop")
		{
			quit();
		}			
...
{
	$.ajax({url: "mdata.php?task=checkLastLoginPro", success: function(result){
		if (result == "stop")
		{
...
function quit()
{
	$.ajax({url: "mdata.php?task=logout", success: function(result){
...
{
	$.ajax({url: "mwebdata.php?status=maintenance", success: function(result){
		if (result == '1') 
		{
...
{
	$.ajax({url: "mdata.php?content=rekening", success: function(result){
...
function getMimpi()
{
	...
	$.ajax({url: "mdata.php?content=mimpi&dimensi="+dimensi+"&search="+vsearch, success: function(result){
		$('#mimpi_content').html(result);
		$('#mimpi_content').fadeIn(500);
	}});
}

function getListKeluaran()
{
	$.ajax({url: "mdata.php?content=listkeluaran", success: function(result){
		$('.listkeluaran').html(result);
		$('.listkeluaran').fadeIn(500);
	}});
}

function getBankOnline()
{
	$.ajax({url: "mdata.php?content=bankonline", success: function(result){
...
function getDeposit()
{
	...
	$.ajax({url: "mdata.php?form=deposit", success: function(result){
...
function getWithdraw()
{
	...
	$.ajax({url: "mdata.php?form=withdraw", success: function(result){
...
function getBetHistory(pasaranid,periode,betid,page)
{
	...
	$.ajax({url: "mdata.php?content=detailTransaksi&pasaranid="+pasaranid+"&periode="+periode+"&betid="+betid+"&page="+page, success: function(result){
...
{
	$('#transaksi .content').html(loadingImg);
	$.ajax({url: "mdata.php?content=detailWin&pasaranid="+pasaranid+"&periode="+periode+"&betid="+betid+"&page="+page+"&win="+win, success: function(result){
		$('#transaksi .content').html(result);
		$('#transaksi .content').fadeIn(500);
	}});
...
$(document).on("change"," .ndc", function()
{
	...
	$.ajax({url: "mdata.php?task=discount&ndc="+ndc, success: function(result){
	...
	$(document).on("click", pasaran+" .confirm", function()
		{
			...
			if (userData.credit >= userData.totalBayar)
			{
			$(pasaran+" .formConfirm").hide();
						  ...
						  setTimeout(function ()
						  {
						  	$(pasaran+' .statusBox').fadeOut(500,function() 
							{
								$(pasaran+' .statusBox')
									...
									.html('Terima kasih, Data berhasil disubmit!<input type="submit" class="btn btn-block btn-success pull-right okbutton" game="'+game+'" style="margin-top:20px" value="Lanjut"><div style="clear:both"></div>').fadeIn(1000);
...
function clickForm(pasaran, game, userData)
	{
		...
		if (total > credit) { alert("Total lebih besar dari Credit Anda"); } 
		else 
			{ 
			...
			if (game == "colokbebas")
			{
				...
				$(pasaran+' .bet').each(function(index) {
					...
					if (realbet >= minbet ) $(pasaran+" .dataConfirm tr:last").after("<tr class=\"form-group-sm\"><td class=\"text-primary\" style=\"vertical-align:middle; width:50px; text-align:center\">"+index+"</td><td width=\"200\" class=\"form-inline\"><input readonly type=\"text\" class=\"form-control\" style=\"width:30px;font-weight:bold\" value="+$(pasaran+' .nomor'+att).val()+"></td><td class=\"text-success\" style=\"vertical-align:middle\">" + bet + "</td><td class=\"text-primary\" style=\"vertical-align:middle\">" + potongan + "</td><td class=\"text-info\" style=\"vertical-align:middle\">" + bayar + "</td></tr>");
				});
			...
			if (game == "colokmacau")
			{
				...
				$(pasaran+' .bet').each(function(index) {
					...
					if (realbet >= minbet && nomor1 != nomor2 && nomor2 != "") $(pasaran+" .dataConfirm tr:last").after("<tr class=\"form-group-sm\"><td class=\"text-primary\" style=\"vertical-align:middle; width:50px; text-align:center\">"+index+"</td><td width=\"200\" class=\"form-inline\"><input readonly type=\"text\" class=\"form-control\" style=\"width:30px;font-weight:bold;float:left\" value="+$(pasaran+' .nomor'+att).val()+">  <input readonly type=\"text\" class=\"form-control\" style=\"width:30px;font-weight:bold;float:left\" value="+$(pasaran+' .nomor2'+att).val()+"></td><td class=\"text-success\" style=\"vertical-align:middle\">" + bet + "</td><td class=\"text-primary\" style=\"vertical-align:middle\">" + potongan + "</td><td class=\"text-info\" style=\"vertical-align:middle\">" + bayar + "</td></tr>");
				});
			...
			if (game == "coloknaga")
			{
				...
				$(pasaran+' .bet').each(function(index) {
					...
					if (realbet >= minbet && nomor1 != nomor2  && nomor1 != nomor3  && nomor2 != nomor3 && nomor3 != "") $(pasaran+" .dataConfirm tr:last").after("<tr class=\"form-group-sm\"><td class=\"text-primary\" style=\"vertical-align:middle; width:50px; text-align:center\">"+index+"</td><td width=\"200\" class=\"form-inline\"><input readonly type=\"text\" class=\"form-control\" style=\"width:30px;font-weight:bold;float:left\" value="+$(pasaran+' .nomor'+att).val()+">  <input readonly type=\"text\" class=\"form-control\" style=\"width:30px;font-weight:bold;float:left\" value="+$(pasaran+' .nomor2'+att).val()+"> <input readonly type=\"text\" class=\"form-control\" style=\"width:30px;font-weight:bold;float:left\" value="+$(pasaran+' .nomor3'+att).val()+"></td><td class=\"text-success\" style=\"vertical-align:middle\">" + bet + "</td><td class=\"text-primary\" style=\"vertical-align:middle\">" + potongan + "</td><td class=\"text-info\" style=\"vertical-align:middle\">" + bayar + "</td></tr>");
				});
			...
			if (game == "colokjitu")
			{
				...
				$(pasaran+' .bet').each(function(index) {
					...
					if (realbet >= minbet && nomor != "" && posisi != "") $(pasaran+" .dataConfirm tr:last").after("<tr class=\"form-group-sm\"><td class=\"text-primary\" style=\"vertical-align:middle; width:50px; text-align:center\">"+index+"</td><td width=\"200\" class=\"form-inline\"><input readonly type=\"text\" class=\"form-control\" style=\"width:30px;font-weight:bold;float:left\" value="+nomor+">  <input readonly type=\"text\" class=\"form-control\" style=\"width:100px;font-weight:bold;float:left\" value="+posisi+"></td><td class=\"text-success\" style=\"vertical-align:middle\">" + bet + "</td><td class=\"text-primary\" style=\"vertical-align:middle\">" + potongan + "</td><td class=\"text-info\" style=\"vertical-align:middle\">" + bayar + "</td></tr>");
				});
			...
			if (game == "5050umum")
			{
				...
				$(pasaran+' .bet').each(function(index) {
					...
					if (realbet >= minbet) $(pasaran+" .dataConfirm tr:last").after("<tr class=\"form-group-sm\"><td class=\"text-primary\" style=\"vertical-align:middle; width:50px; text-align:center\">"+index+"</td><td width=\"200\" class=\"form-inline\"><input readonly type=\"text\" class=\"form-control\" style=\"width:100px;font-weight:bold\" value="+nomor+"></td><td class=\"text-success\" style=\"vertical-align:middle\">" + bet + "</td><td class=\"text-primary\" style=\"vertical-align:middle\">" + potongan + "</td><td class=\"text-info\" style=\"vertical-align:middle\">" + bayar + "</td></tr>");
				});
			...
			if (game == "5050special")
			{
				...
				$(pasaran+' .bet').each(function(index) {
					...
					if (realbet >= minbet) $(pasaran+" .dataConfirm tr:last").after("<tr class=\"form-group-sm\"><td class=\"text-primary\" style=\"vertical-align:middle; width:50px; text-align:center\">"+index+"</td><td width=\"200\" class=\"form-inline\"><input readonly type=\"text\" class=\"form-control\" style=\"width:90px;font-weight:bold;float:left\" value="+tebak+"> <input readonly type=\"text\" class=\"form-control\" style=\"width:70px;font-weight:bold;float:left\" value="+nomor+"></td><td class=\"text-success\" style=\"vertical-align:middle\">" + bet + "</td><td class=\"text-primary\" style=\"vertical-align:middle\">" + potongan + "</td><td class=\"text-info\" style=\"vertical-align:middle\">" + bayar + "</td></tr>");
				});
			...
			if (game == "5050kombinasi")
			{
				...
				$(pasaran+' .bet').each(function(index) {
					...
					if (realbet >= minbet) $(pasaran+" .dataConfirm tr:last").after("<tr class=\"form-group-sm\"><td class=\"text-primary\" style=\"vertical-align:middle; width:50px; text-align:center\">"+index+"</td><td width=\"200\" class=\"form-inline\"><input readonly type=\"text\" class=\"form-control\" style=\"width:90px;font-weight:bold;float:left\" value="+tebak+"> <input readonly type=\"text\" class=\"form-control\" style=\"width:100px;font-weight:bold;float:left\" value="+nomor+"></td><td class=\"text-success\" style=\"vertical-align:middle\">" + bet + "</td><td class=\"text-primary\" style=\"vertical-align:middle\">" + potongan + "</td><td class=\"text-info\" style=\"vertical-align:middle\">" + bayar + "</td></tr>");
				});
			...
			if (game == "kombinasi")
			{
				...
				$(pasaran+' .bet').each(function(index) {
					...
					if (realbet >= minbet) $(pasaran+" .dataConfirm tr:last").after("<tr class=\"form-group-sm\"><td class=\"text-primary\" style=\"vertical-align:middle; width:50px; text-align:center\">"+index+"</td><td width=\"200\" class=\"form-inline\"><input readonly type=\"text\" class=\"form-control\" style=\"width:90px;font-weight:bold; float:left\" value="+tebak+"> <input readonly type=\"text\" class=\"form-control\" style=\"width:80px;font-weight:bold; float:left\" value="+nomor+"> <input readonly type=\"text\" class=\"form-control\" style=\"width:80px;font-weight:bold; float:left\" value="+nomor2+"></td><td class=\"text-success\" style=\"vertical-align:middle\">" + bet + "</td><td class=\"text-primary\" style=\"vertical-align:middle\">" + potongan + "</td><td class=\"text-info\" style=\"vertical-align:middle\">" + bayar + "</td></tr>");
				});
			...
			if (game == "dasar")
			{
				...
				$(pasaran+' .bet').each(function(index) {
					...
					if (realbet >= minbet) $(pasaran+" .dataConfirm tr:last").after("<tr class=\"form-group-sm\"><td class=\"text-primary\" style=\"vertical-align:middle; width:50px; text-align:center\">"+index+"</td><td width=\"200\" class=\"form-inline\"><input readonly type=\"text\" class=\"form-control\" style=\"width:70px;font-weight:bold\" value="+nomor+"></td><td class=\"text-success\" style=\"vertical-align:middle\">" + bet + "</td><td class=\"text-primary\" style=\"vertical-align:middle\">" + potongan + "</td><td class=\"text-info\" style=\"vertical-align:middle\">" + bayar + "</td></tr>");
				});
			...
			if (game == "shio")
			{
				...
				$(pasaran+' .bet').each(function(index) {
					...
					if (realbet >= minbet) $(pasaran+" .dataConfirm tr:last").after("<tr class=\"form-group-sm\"><td class=\"text-primary\" style=\"vertical-align:middle; width:50px; text-align:center\">"+index+"</td><td width=\"150\" class=\"form-inline\"><input readonly type=\"text\" class=\"form-control\" style=\"width:120px;font-weight:bold\" value="+nomor+"></td><td class=\"text-success\" style=\"vertical-align:middle\">" + bet + "</td><td class=\"text-primary\" style=\"vertical-align:middle\">" + potongan + "</td><td class=\"text-info\" style=\"vertical-align:middle\">" + bayar + "</td></tr>");
				});
...
function linkGame4D(pasaran, pasar, game, form, aturan)
{
		clearStatus(pasaran);
			...
			$.ajax({url: "mform.php?form="+form+"&p="+pasar, success: function(result){
				//alert(pasaran+pasar);
...
function linkGame(pasaran, pasar, game)
{
	clearStatus(pasaran);
		...
		$(pasaran+' .formContainer').html(loadingImg);
		$.ajax({url: "mform.php?form="+game.toLowerCase()+"&p="+pasar, success: function(result){
			$(pasaran+' .formContainer').html(result);
			$(pasaran+' .formContainer').fadeTo(500,1);
			getStatus();
...
function getPeraturan(pasaran, game){
		...
		$.ajax({url: 'mdata.php?content=peraturan&game='+game, success: function(result){
				//alert(pasaran+pasar);
				...
				if (result != '')
				{
					...
					var pasar = pasaran.substr(1);
					$.ajax({url: 'mdata.php?content=hadiah&pasaran='+pasar+'&game='+game, success: function(result){
						//alert(result);
...
function getStatus(){
       $.getJSON('mdata.php?status=pasaran', function(data) {
			...
			for (i = 0; i < data.length; i++)
			{
				...
				// Nama Pasaran
				$('.nama_pasaran_'+nama).text(data[i].name);
			}
        });
}

function getWinBet(){
       $.getJSON('mdata.php?status=winBet', function(data) {
...
function getDepoWD(){
       $.getJSON('mdata.php?status=depoWD', function(data) {
...
function getReferal(t,s){
		   ...
		   $.ajax({url: "mdata.php?content=referal&sort="+s+"&page="+t, success: function(result){
...
function getTransaksi(t){
		   $('#transaksi .content').html(loadingImg);
		   $.ajax({url: "mdata.php?content=transaksi&page="+t, success: function(result){
		   		$('#transaksi .content').html(result);
				$('#transaksi .content').fadeIn(500);
        }});
}
...
function getStatement(){
		   ...
		   $.ajax({url: "mdata.php?content=statement", success: function(result){
...
function getTabKeluaran(){
		   ...
		   $.ajax({url: "mdata.php?content=tabKeluaran", success: function(result){
...
function getInbox(i)
{
			$.ajax({url: "mdata.php?content=inbox&page="+i, success: function(result){
...
function getSent(i)
{
			$.ajax({url: "mdata.php?content=sent&page="+i, success: function(result){
...
function getTulis()
{
			 $.ajax({url: "mdata.php?content=tulis", success: function(result){
...
function readMemo(task, page, i) {
			 $.ajax({url: "mdata.php?read=memo&page="+page+"&task="+task+"&id="+i, success: function(result){
...
{
	$.ajax({url: "mdata.php?content=memoBadge", success: function(result){
...
function getKeluaran(pid,i){
			...
			else
			{
			   ...
			   $.ajax({url: "mdata.php?content=keluaran&pid="+pid+"&page="+i, success: function(result){
...
function getSetting() {
		$.getJSON('mdata.php?status=setting', function(data) {
...
function openinit(nama)
{
				...
				$.ajax({url: "mform.php?form=qb&p="+nama, success: function(result){
...
{
	$.ajax({url: "mdata.php?content=broadcast", success: function(result){
       ...
       $.getJSON('mdata.php?status=pasaran', function(data) {
					...
					{	
						...
						else
						{
							$("#deposit_form").fadeOut(500, function()
							{
								...
								$.post("mdata.php", $('.deposit_form').serialize(),
									function(data)
									{
										  if (data == 'success')
										  {
		...
		$(document).on("click", ".kirim", function()
		{
			...
			if (tulissubject != "")
			{
				if (memolength >= 10)
				{
					$.post("mdata.php", $('.tulis_form').serialize(),
						function(data)
						{
							  if (data == 'success')
							  {
		...
		$(document).on("click", ".balas", function()
		{
			...
			if (memolength >= 10)
			{
				$.post("mdata.php", $('.balas_form').serialize(),
					function(data)
					{
						  if (data == 'success')
						  {
		...
		{		
				...
				$.post("mdata.php", $('.pass_form').serialize(),
					function(data)
					{
						setTimeout(function ()
						{  
				...
				if (credit >= withdraw)
				{
					...
					{	
						$("#withdraw_form").fadeOut(500, function()
						{
							...
							$.post("mdata.php", $('.withdraw_form').serialize(),
								function(data)
								{
									  if (data == 'success')
									  {
									  ...
									  if (data == 'receh')
									  {
										  setTimeout(function ()
										  {
											$('#statusWithdraw').fadeOut(500,function() 
											{
												$('#statusWithdraw').removeClass('alert alert-warning text-center glyphicon glyphicon-alert').addClass("alert alert-danger text-center").text('Maaf Withdraw harus kelipatan '+ ribuan(kelipatan)).fadeIn(1000);
												});
		...
		{
			var bank = $(this).val()
			if (bank == 'Telkomsel' || bank == 'Axiata' || bank == 'Indosat' || bank == 'OVO' || bank == 'GOPAY' || bank == 'DANA')
			{
				$("#input_pengirim").show();
			}
			else
		...
		$(document).on("click", "#addrek", function()
		{
			...
			$.post("mdata.php", $('.addrek_form').serialize(),
				function(data)
				{
					  if (data == 'success')
					  {
		...
		$(document).on("click", "#updaterek", function()
		{
			...
			$.post("mdata.php", $('.updaterek_form').serialize(),
				function(data)
				{
					  if (data == 'success')
					  {
