...
<div class="tab-content">
    ...
    <div id="toto_wrap" class="tab-pane fade in active">
        ...
        <div style="font-weight:bold; margin-bottom:5px; font-size:12px;">
            ...
            <span class="glyphicon glyphicon-menu-right"></span>SAKA 4D
        </div>
        <div class="well well-sm">
            <strong>Website : </strong><a href="http://www.saka4d.com" target="_blank">www.saka4d.com</a><br />
            <strong>Hari Bukaan : </strong>Setiap Hari<br />
            <strong>Hari Libur : </strong>N/A<br />
            <strong>Jam Tutup : </strong>23:30 WIB
            <strong style="margin-left: 20px">Jam Undian : </strong>23:59 WIB<br />
        </div>
        <div class="row">
    ...
    <div id="games_wrap" class="tab-pane fade in"></div>
</div>