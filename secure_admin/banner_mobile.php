        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">Banner Mobile</h4>
                </div>
            </div>
        </div>
        <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="modal-footer">
                                                        <?php if ($_SESSION['level'] === 'superadmin') : ?>
                                                            <button type="submit" name="submitAddBanner" class="btn btn-primary" id="saveBtn">Tambah Banner</button>
                                                        <?php else : ?>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><img src="../banner/<?php echo $banner['image_path']; ?>" alt="<?php echo $banner['alt_text']; ?>" width="50px"></td>
                                            <?php if ($_SESSION['level'] === 'superadmin') : ?>
